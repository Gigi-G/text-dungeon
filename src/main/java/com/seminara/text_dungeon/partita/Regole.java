...
public class Regole implements IGameState {
    ...
    private void printBattagliaInfo() {
        ...
        System.out.println("L’Assalto batte la Difesa e chi si trova nello stato di Difesa subisce un danno pari alla metà dio quello che può essere inflitto da chi si trova nello stato di assalto.");
